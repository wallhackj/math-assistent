...
from featch_data import fetch_dataset

X_train, Y_train, X_test, Y_test = fetch_dataset(.9)

# create a model
class TinyBobNet:
  def __init__(self):
    self.l1 = Tensor.scaled_uniform(2025, 128)
...
class TinyConvNet:
  ...
  def forward(self, x:Tensor):
    x = x.reshape(shape=(-1, 1, 45, 45)) # hacks
